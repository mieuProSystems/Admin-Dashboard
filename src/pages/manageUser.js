                                        ...
                                        <tr className='d-flex'>
                                            ...
                                            {(adminData.isLogged===true)?(<td className="col-lg-2"></td>):(
                                                <td className="col-lg-2">
                                                    <button className="button" style={{backgroundColor:'white', border:'1px', borderColor:'#2c3e50', borderStyle:'solid'}} userMail={adminData.userMail} onClick={(event)=>{this.removeAdminAccount(event)}}>Remove</button>
                                                </td>)}
                                        </tr>
                                    </thead>
                                    );
                                    ...
                                    <thead>
                                        <tr className='d-flex'>
                                            ...
                                            <td className="col-lg-3">
                                                <button className="button" style={{backgroundColor:'white', border:'1px', borderColor:'#2c3e50', borderStyle:'solid'}} userMail={userData.email} onClick={(event)=>{this.removeUser(event)}}>Remove</button>
                                            </td>
                                        </tr>
                                    </thead>
                                    );
